package com.test.mvvm.aac.fragment
...
import com.test.mvvm.aac.viewmodel.VmShareViewModel
import com.test.mvvm.databinding.FragmentSeekbarBinding
...
class SeekbarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var viewModel = ViewModelProviders.of(requireActivity()).get(VmShareViewModel::class.java)

        var binding: FragmentSeekbarBinding? = DataBindingUtil.bind(view)
